...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-8">
      <div>
        <h2 className="text-3xl font-serif font-medium text-foreground tracking-tight">Panorama Financeiro</h2>
        <p className="text-muted-foreground text-sm mt-1">Acompanhe seus saldos e movimentações recentes.</p>
      </div>
